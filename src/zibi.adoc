[[zibi]]
== "Zibi" Extension for Branch with Immediate, Version 0.1
...
The offset is sign-extended and added to the address of the branch instruction to give the target address. The branch range is ±4 KiB.
